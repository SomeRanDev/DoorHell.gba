/**
 * Modified version of `bitmap`.
 * 
 * Had to change the `Buffer` import.
 * https://github.com/CesiumLabs/bitmap/issues/1
 * 
 * https://deno.land/x/bitmap@v1.0.1
 * https://github.com/CesiumLabs/bitmap/tree/v1.0.1
 * https://raw.githubusercontent.com/CesiumLabs/bitmap/v1.0.1/src/Encoder.ts
 * 
**/
